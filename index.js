...
function testScreenCapture() {
    ...
    var pixel_color = img.colorAt(887,  92);
...
function findTree() {
    ...
    var tree_colors = ["5b0c07"];
    //var tree_colors = ["5b0c07", "423912", "3e3310", "42301a", "4e330e", "bca537"];
    ...
    for (var i = 0; i < 500; i++) {
        ...
        if (tree_colors.includes(sample_color)) {
            ...
            console.log("Found a CHICKEN at: " + screen_x + ", " + screen_y + " color " + sample_color);
